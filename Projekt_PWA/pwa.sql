...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1767897862ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pwa&table=korisnik">`pwa`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pwa&table=vijesti">`pwa`.`vijesti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pwa&table=Vijesti">`pwa`.`Vijesti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=korisnik">`studij`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=zaposlenik">`studij`.`zaposlenik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=predmet">`studij`.`predmet`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=student">`studij`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=studij&table=Student">`studij`.`Student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=zad1&table=users">`zad1`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4476274b7b2e226c327222397630472f">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="pwa" targettable="korisnik">
